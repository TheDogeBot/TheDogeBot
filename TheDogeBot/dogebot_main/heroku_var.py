...
class config(object):
    ...
    TheDogeBot_NAME = os.environ.get("TheDogeBot_NAME", None)
    ...
    UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL","https://github.com/rekcah-pavi/TheDogeBot")
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "TheDogeBot")
    CONSOLE_LOGGER_VERBOSE = sb(os.environ.get("CONSOLE_LOGGER_VERBOSE", "False"))
